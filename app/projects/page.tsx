	...
	return (
		<>
			...
			<div
				id='adsfajkd'
				ref={container}
				className='flex items-center flex-nowrap w-fit   h-screen bg-secondary-foreground'>
				<div className='h-[60vh] w-[50vw] px-4 shrink-0 box   '>
					<div className='rounded-lg bg-white w-full h-full'></div>
				</div>
				<div className=' h-[60vh] w-[50vw] px-4 shrink-0 box   '>
					<div className='rounded-lg bg-green-700 w-full h-full'></div>
				</div>
				<div className=' h-[60vh] w-[50vw] px-4 shrink-0 box   '>
					<div className='rounded-lg bg-yellow-700 w-full h-full'></div>
				</div>
				<div
					id='myBox'
			...
			<div
				...
				<div ref={slider} className='h-10 w-10 bg-green-400'></div>
			</div>
